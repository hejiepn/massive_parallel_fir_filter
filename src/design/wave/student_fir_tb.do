...
add wave -noupdate -group bram_coeff -expand /student_fir_tb/dut/coeff_dpram/dpram_samples/bram
...
add wave -noupdate -expand -group bram_samples /student_fir_tb/dut/samples_dpram/dpram_samples/AddrWidth
add wave -noupdate -expand -group bram_samples /student_fir_tb/dut/samples_dpram/dpram_samples/DataSize
add wave -noupdate -expand -group bram_samples /student_fir_tb/dut/samples_dpram/dpram_samples/DebugMode
add wave -noupdate -expand -group bram_samples /student_fir_tb/dut/samples_dpram/dpram_samples/dob
add wave -noupdate -expand -group bram_samples /student_fir_tb/dut/samples_dpram/dpram_samples/temp_bram
add wave -noupdate -expand -group bram_samples -expand /student_fir_tb/dut/samples_dpram/dpram_samples/bram
...
add wave -noupdate -expand -group fir /student_fir_tb/dut/DATA_SIZE
add wave -noupdate -expand -group fir /student_fir_tb/dut/DEBUGMODE
add wave -noupdate -expand -group fir /student_fir_tb/dut/DATA_SIZE_FIR_OUT
...
add wave -noupdate -expand -group fir /student_fir_tb/dut/tl_i
add wave -noupdate -expand -group fir /student_fir_tb/dut/tl_o
...
add wave -noupdate -expand -group fir /student_fir_tb/dut/TLUL_DPRAM_DEVICES
add wave -noupdate -expand -group fir /student_fir_tb/dut/tl_student_dpram_i
add wave -noupdate -expand -group fir /student_fir_tb/dut/tl_student_dpram_o
add wave -noupdate -expand -group fir_reg /student_fir_tb/dut/reg2hw
add wave -noupdate -expand -group fir_reg /student_fir_tb/dut/hw2reg
...
WaveRestoreCursors {{Cursor 1} {3418683603 fs} 0}
